...
This new emulator has SID sound, sprite priorities, digis, and more (things that the C# prototype had not). SID was so ahead for its time (remember that it has been made in 1982, so it's a chip that is almost 40 years old).
